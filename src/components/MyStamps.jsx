...
export default function MyStamps() {
  ...
  const stampsInCurrentRow = result?.stamps ? (result.stamps % 10 === 0 && result.stamps > 0 ? 10 : result.stamps % 10) : 0;
  const completedRows = result ? Math.floor(result.stamps / 10) : 0;
  const stampsForNext = result ? (10 - (result.stamps % 10)) % 10 || 10 : 10;
          ...
          <div className="card" style={{ padding: 28 }}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              <div style={{
                ...
                margin: "0 auto 16px",
                fontSize: 36,
                boxShadow: "0 8px 24px rgba(54,177,223,0.3)"
              }}>
                🎫
              </div>
              <h2 style={{
            ...
            {result.stamps > 0 ? (
              <>
                ...
                <div style={{
                  ...
                  {stampsForNext < 10 && stampsForNext > 0 && (
                    <p style={{
                      ...
                      🎁 ¡Solo {stampsForNext} {stampsForNext === 1 ? 'sello' : 'sellos'} para tu próximo premio!
                    </p>
                  )}
                  ...
                  {completedRows > 0 && (
                    <p style={{
                      ...
                      🏆 Has completado {completedRows} tarjeta{completedRows > 1 ? 's' : ''}
                    </p>
                  )}
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: 10, color: "var(--text-muted)", textTransform: "uppercase", fontWeight: 600, marginBottom: 4 }}>Visitas</p>
              ...
              <div style={{
                ...
                <p style={{ fontSize: 13, color: "var(--text-muted)", marginTop: 8 }}>
                  Junta 10 sellos y desbloquea un premio 🎁
                </p>
              </div>
            )}

            <div style={{ display: "flex", gap: 10 }}>
              <button className="btn-ghost" onClick={handleNewSearch} style={{ flex: 1 }}>
                Buscar otro
              </button>
          ...
          <div className="card" style={{ padding: 28 }}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <p style={{ color: "var(--text-tertiary)", fontSize: 13 }}>
                Consulta tu tarjeta de lealtad
              </p>
            </div>
